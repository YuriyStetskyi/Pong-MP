...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_AMyPlayerController_Server_MoveOnInput_Statics::Function_MetaDataParams[] = {
		{ "Comment", "//movement RPCS\n" },
		{ "ModuleRelativePath", "MyPlayerController.h" },
		{ "ToolTip", "movement RPCS" },
	};
#endif
...
#if WITH_METADATA
		static const UE4CodeGen_Private::FMetaDataPairParam NewProp_found_bluePlatform_MetaData[];
#endif
		static const UE4CodeGen_Private::FObjectPropertyParams NewProp_found_bluePlatform;
		static const UE4CodeGen_Private::FPropertyParamsBase* const PropPointers[];
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AMyPlayerController_Statics::FuncInfo[] = {
		...
		{ &Z_Construct_UFunction_AMyPlayerController_Server_MoveOnInput, "Server_MoveOnInput" }, // 2467396415
	};
#if WITH_METADATA
...
#if WITH_METADATA
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_AMyPlayerController_Statics::NewProp_found_bluePlatform_MetaData[] = {
		{ "Category", "MyStuff" },
		{ "ModuleRelativePath", "MyPlayerController.h" },
	};
#endif
	const UE4CodeGen_Private::FObjectPropertyParams Z_Construct_UClass_AMyPlayerController_Statics::NewProp_found_bluePlatform = { "found_bluePlatform", nullptr, (EPropertyFlags)0x0040000000000001, UE4CodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, STRUCT_OFFSET(AMyPlayerController, found_bluePlatform), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(Z_Construct_UClass_AMyPlayerController_Statics::NewProp_found_bluePlatform_MetaData, UE_ARRAY_COUNT(Z_Construct_UClass_AMyPlayerController_Statics::NewProp_found_bluePlatform_MetaData)) };
	const UE4CodeGen_Private::FPropertyParamsBase* const Z_Construct_UClass_AMyPlayerController_Statics::PropPointers[] = {
		...
		(const UE4CodeGen_Private::FPropertyParamsBase*)&Z_Construct_UClass_AMyPlayerController_Statics::NewProp_found_bluePlatform,
	};
	...
	IMPLEMENT_CLASS(AMyPlayerController, 1795398989);
