#undef TESTTASK_FAROMSTUDIO_API
...
#define UE_PROJECT_NAME TestTask_FaromStudio
#define UE_TARGET_NAME TestTask_FaromStudioEditor
#define UE_MODULE_NAME "TestTask_FaromStudio"
...
#define TESTTASK_FAROMSTUDIO_API DLLEXPORT
